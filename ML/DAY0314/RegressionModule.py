...
class RegressionModule:
    ...
    def polyFeature(self, X_train = X_train, X_test= X_test, 
                    y_train = y_train, y_test=y_test, deGree=2, interactionTF = False, include_biasTF = True):
    ...
    def lr(self, X_train = X_train, X_test= X_test, 
    ...
    def RLE(type, X_train = X_train, X_test= X_test, 
                    y_train = y_train, y_test=y_test,  alphaList=alphaList1):
