...
# # CCTV 영상 스트림 URL
# CCTV_URL = "https://www.utic.go.kr/jsp/map/cctvStream.jsp?cctvid=E902565..."

# # 저장할 경로 (업로드 폴더와 동일하게 설정)
# UPLOAD_DIR = "../upload"
...
#         cropped = img.crop((100, 150, 1180, 700))  # (left, top, right, bottom)
#         cropped.save(SAVE_PATH)

#         print(f"CCTV 캡처 완료: {SAVE_PATH}")
#     finally:
#         driver.quit()
